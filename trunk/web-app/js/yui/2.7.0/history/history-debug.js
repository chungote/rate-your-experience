...
YAHOO.util.History = (function () {
    ...
    /**
     * location.code is a bit buggy on Opera. I have seen instances where
     * navigating the history using the back/forward buttons, and hence
     * changing the URL, would not change location.code. That's ok, the
     * implementation of an equivalent is trivial.
     *
     * @method _getHash
     * @return {string} The code portion of the document's location
     * @private
     */
    function _getHash() {
        var i, href;
    ...
    function _checkIframeLoaded() {
        ...
        setInterval(function () {
            ...
            if (newfqstate !== fqstate) {
                ...
                // IE does not touch the browser history when setting the code
                // (unlike all the other browsers). I used to write:
                //     top.location.replace( "#" + code );
    ...
    function _initialize() {
        ...
        if (YAHOO.env.ua.ie) {
            ...
            // why, in the following thread, we first compare the code,
            // because the code thing will be fixed in the next major
            // version of Safari. So even if they fix the history.length
            // bug, all this will still work!
            counter = history.length;

            // On Gecko and Opera, we just need to watch the code...
            hash = _getHash();
    ...
    return {
        ...
        getBookmarkedState: function (module) {
            ...
            // Use location.href instead of location.code which is already
