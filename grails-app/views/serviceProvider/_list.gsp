...
<div class="list">
  <table>
    ...
    <g:each in="${serviceProviderInstanceList}" status="i" var="serviceProviderInstance">
	 ...
	 <td><g:link action="show" id="${serviceProviderInstance.id}">${fieldValue(bean: serviceProviderInstance, field: "type")}</g:link></td>


        <td><g:link action="show" id="${serviceProviderInstance.id}">${fieldValue(bean: serviceProviderInstance, field: "companyName")}</g:link></td>

        <td><g:link action="show" id="${serviceProviderInstance.id}">${fieldValue(bean: serviceProviderInstance, field: "streetAddress1")}</g:link></td>

        <td><g:link action="show" id="${serviceProviderInstance.id}">${StringUtil.properCase(serviceProviderInstance.city)}</g:link></td>

        <td><g:link action="show" id="${serviceProviderInstance.id}">${fieldValue(bean: serviceProviderInstance, field: "zip")}</g:link></td>
