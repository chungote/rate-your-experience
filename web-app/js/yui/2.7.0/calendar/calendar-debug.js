...
(function () {
    ...
    YAHOO.util.Config = function (owner) {
        ...
        if (!owner) {
            YAHOO.log("No owner specified for Config object", "error", "Config");
        }
    ...
    Config.prototype = {
        ...
        /**
         * Adds a property to the Config Object's private config code.
         * @method addProperty
         * @param {String} key The configuration property's name
    ...
    Calendar.prototype = {
        ...
        init : function(id, container, config) {
            ...
            if (!this.oDomContainer) {
                this.logger.log("Container not found in document.", "error");
            }
        ...
        select : function(date) {
            ...
            if (validDates.length === 0) {
                this.logger.log("All provided dates were OOB. beforeSelect and select events not fired", "info");
            }
        ...
        selectCell : function(cellIndex) {
            ...
            if (!selectable) {
                this.logger.log("The cell at cellIndex:" + cellIndex + " is not a selectable cell. beforeSelect, select events not fired", "info");
            }
        ...
        deselect : function(date) {
            ...
            if (validDates.length === 0) {
                this.logger.log("All provided dates were OOB. beforeDeselect and deselect events not fired");
            }
        ...
        deselectCell : function(cellIndex) {
            ...
            if (!selectable) {
                this.logger.log("The cell at cellIndex:" + cellIndex + " is not a selectable/deselectable cell", "info");
            }
