...
YAHOO.util.Cookie = {
    ...
    /**
     * Parses a cookie code string into an object.
     * @param {String} text The cookie code string to parse. The string should already be URL-decoded.
    ...
    /**
     * Sets a cookie with a given name to contain a code of name-value pairs.
     * @param {String} name The name of the cookie to set.
