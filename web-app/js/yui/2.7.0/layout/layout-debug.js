...
(function() {
     ...
     * @static
     * @property _instances
     * @description Internal code table for all layout instances
     * @type Object
     */
    Layout._instances = {};
    /**
...
(function() {
     ...
     * @static
     * @property _instances
     * @description Internal code table for all layout unit instances
     * @type Object
     */
    ...
    YAHOO.extend(LayoutUnit, YAHOO.util.Element, {
         ...
         * @private
         * @property _gutter
         * @description A simple code table used to store the gutter to apply to the Unit
         * @type Object
         */
        _gutter: null,
        /**
