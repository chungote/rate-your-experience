        ...
        function dispatch(hd, config) {
            ...
            if (obj.isAlive(hd)) {
                ...
                if ($L.isObject(node) && node.src) {
                    ...
                    config.hash = _hashtable.length; // default code (at the end of the table)
                            ...
                            if (node.type === constants.JSNODE) {
                                ...
                                config.handle = YAHOO.util.Get.script(uri, {
                                    onSuccess: function() {
                                        ...
                                        config.hash = null; // resetting the config.code for the next iteration...
                    ...
                    // the node represent an inline script (don't have code value)
                    config.hash = null;
